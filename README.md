...
- **3D 로봇 뷰어** — Three.js + URDF 기반 실시간 3D 모델 (관절/그리퍼/바퀴 애니메이션, OrbitControls)
...
| 레이어 | 기술 |
|--------|------|
| Frontend | Vue 3 + Vuetify 3 + Vite + Three.js |
...
└── src/
    ...
    │   ├── useRobotControl.js   # STOMP: cmd_vel, arm, gripper + lastCmdVel (3D 바퀴용)
    ...
    │   ├── RobotViewer3D.vue    # Three.js URDF 3D 로봇 뷰어
